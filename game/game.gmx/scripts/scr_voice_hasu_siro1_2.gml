...
ds_queue_enqueue(opp_words[? "s2_p2"],"[spr]hasu_bind_siro,0",0.1,"ふふ……#お前も我慢できないんだろう？","もっと善がらせてやろう","まだまだ可愛がってやるぞ？","どろどろに蕩けそうか？");
...
ds_queue_enqueue(opp_words[? "s2_p4_0"],"[spr]hasu_bind_siro,1","よしよし#素直な良い子だ……",400,"さあ、ゆくぞ#たっぷり味わうといい",0.2);
...
ds_queue_enqueue(opp_words[? "s2_p5_0"],"[spr]hasu_bind_siro,2",0.15,0.1,0.05,0.15,0.1,0.05,"ぐるぅう……!!!");
...
ds_queue_enqueue(opp_words[? "s2_p4_1"],"[spr]hasu_bind_siro,1","逃すわけがなかろう？");
...
ds_queue_enqueue(opp_words[? "s2_p5_1"],"[spr]hasu_bind_siro,2",0.15,0.1,0.05,0.15,0.2,0.25,0.1,0.06,0.04,"ぐるぅう……!!!");
...
ds_queue_enqueue(opp_words[? "s2_p6_0"],"[spr]hasu_stand,0",0.1,"ふう、好かったぞ","また来ても良いぞ",50);
...
ds_queue_enqueue(opp_words[? "s2_p6_1"],"[spr]hasu_stand,0",0.1,"ふう、好かったぞ","また来ても良いぞ",50);
